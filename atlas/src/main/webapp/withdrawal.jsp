...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Withdrawal Section ======= -->
    <section id="withdrawal" class="contact">
      <div class="container">
          ...
          <div class="col-lg-3 mt-5 mt-lg-0" data-aos="fade-left">
            ...
            <form action="transaction" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit">Withdraw</button></div>
            </form>
    ...
    </section><!-- End Withdrawal Section -->
